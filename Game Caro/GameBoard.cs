...
namespace Game_Caro
{
    class GameBoard
    {
        ...
        #region Initialize
        public GameBoard(Panel board, TextBox PlayerName, PictureBox Avatar, Label ScoreLabel)
        {
            this.Board = board;
            ...
            {
                new Player("Player1", Image.FromFile(Application.StartupPath + "\\images\\X_Image.png"),
                                        Image.FromFile(Application.StartupPath + "\\images\\X_Image.png")),

                new Player("Player2", Image.FromFile(Application.StartupPath + "\\images\\O_Image.png"),
                                   Image.FromFile(Application.StartupPath + "\\images\\O_Image.png"))
            };
        ...
        public void EndGame()
        {
            if (CurrentPlayer == 1)  // Nếu lượt tiếp là player 2 -> player 1 vừa đánh và thắng
                player1Score++;
            else  // Nếu lượt tiếp là player 1 -> player 2 vừa đánh và thắng
                player2Score++;
        ...
        {
            if (player1Score >= 5) return 1;
            if (player2Score >= 5) return 2;
            return 0;
        }
    }
}